# Contributing to done-ssr-incremental-rendering-client

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/donejs/done-ssr-incremental-rendering-client) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork done-ssr-incremental-rendering-client, you can start by going to its [fork page](https://github.com/donejs/done-ssr-incremental-rendering-client/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/done-ssr-incremental-rendering-client
```
...
```shell
cd done-ssr-incremental-rendering-client
```
